...
| Requirement | Notes |
|-------------|--------|
| **Windows 10/11** | v0.5 ships as a desktop app (WebView2; usually preinstalled on Win 11) |
...
1. Download **`CitiesAI-Setup-0.5.exe`** from [Releases](https://github.com/XharvaK/CitiesAI/releases).
