...
| Command | Purpose |
|---------|---------|
| `citiesai gui` | Local desktop app: dashboard, ask, settings, feedback |
...
See [CONTRIBUTING.md](CONTRIBUTING.md). Release build: `powershell -ExecutionPolicy Bypass -File scripts\build-release.ps1`
