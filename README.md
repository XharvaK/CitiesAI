...
| Requirement | Notes |
|-------------|--------|
| **Windows 10/11** | Desktop app (WebView2; usually preinstalled on Win 11) — current release **0.7.1** |
...
See [CHANGELOG.md](CHANGELOG.md) for 0.7.1 release notes.

1. Download **`CitiesAI-Setup-0.7.1.exe`** from [Releases](https://github.com/XharvaK/CitiesAI/releases).
