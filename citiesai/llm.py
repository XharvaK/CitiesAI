...
_ADVISOR_STYLE_DIRECTIVES = {
    "civic": (
        ...
        "- When using Gameplay output format: prefer short diagnosis and a tight action "
        "list.\n"
    ...
    "conversational": (
        ...
        "- Keep the same evidence rules; when using Gameplay output format, keep numbered "
        "actions but sound more natural.\n"
    ...
    "analyst": (
        ...
        "- When using Gameplay output format: open with diagnosis, then numbered actions; "
        "you may add a short evidence note.\n"
...
def build_system_prompt(
    *,
    ...
    base = (
        ...
        "advice.\n"
        "- City character / classification / judgment (is this a pop farm or megapolis, "
        "efficient or livable, what kind of city is this, aesthetic vs max-population): "
        "answer the asked distinction directly in plain prose with 1-3 snapshot-backed "
        "sentences. Skip the numbered action list unless the user also asks what to "
        "improve or fix.\n"
        "- Gameplay fix/improve/build/diagnose (traffic, budget, housing, services, "
        "demand, or other \"what should I do\" city problems): use the Gameplay output "
        "format below.\n"
        "- App, setup, definitional, and classification questions: answer in plain prose; "
        "skip the numbered action list.\n\n"
        "Gameplay output format (only when routing says to use it):\n"
        ...
        "Guardrails:\n"
        "- Answer the question asked. Do not turn classification, comparison, or "
        "\"what is this city?\" questions into unsolicited optimization lists.\n"
