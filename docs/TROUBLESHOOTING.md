...
4. Wait up to 60 seconds for first export.
...
Export refreshes every ~60 seconds. If `citiesai context` shows `stale (>90 sec)`, load the correct city in-game or wait for the next cycle.
